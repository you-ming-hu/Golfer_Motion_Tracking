...
class DataProcessorBase:
    def __init__(self):
        ...
        self.process_coco_human_param = {'w_full':0.95,'h_full':0.8,'hm_psize_ratio':common.hm_joint_ratio}
        self.process_coco_dummy_param = {}
        self.process_golfer_param = {'clubhead_ratio':common.hm_clubhead_ratio}
